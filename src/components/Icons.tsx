...
export function Hand1({
	...
	return (
		<svg
			...
			height={height}
			fill="currentColor"
			className="md:w-[var(--svg-size)] md:h-[var(--svg-size)] w-[60px] h-[60px]"
			role="image"
		>
...
export function Hand2({
	...
	return (
		<svg
			...
			height={height}
			fill="currentColor"
			className="w-[var(--svg-size)] h-[var(--svg-size)]"
			role="image"
		>
...
export function Starburst() {
	return (
		<svg
			...
			fill="currentColor"
			role="image"
			className="w-[20px] h-[20px] animate-none"
		>
...
export function CogShape({ ...props }: React.SVGAttributes<SVGElement>) {
	return (
		<svg
			viewBox="0 0 480 480"
			xmlns="http://www.w3.org/2000/svg"
